# -*- coding: utf-8 -*-
"""
Django settings for CyberSee project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'cybersee.contrib.sites.migrations'
}
...
ADMINS = [
    ...
    ("""Cameron Chilton""", 'cameron@cyberbyte.org.uk'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///cybersee'),
}
...
ACCOUNT_ADAPTER = 'cybersee.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'cybersee.users.adapters.SocialAccountAdapter'
...
########## CELERY
INSTALLED_APPS += ['cybersee.taskapp.celery.CeleryConfig']
